        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.user.departmentId) {
                    localStorage.setItem('department_id', data.user.departmentId);
                }
                if (data.user.features) {
                    localStorage.setItem('user_features', JSON.stringify(data.user.features));
                }
            ...
            setError('Connection failed. Please check your database.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-[#f4f5f6] flex items-center justify-center p-4">
            <div className="max-w-md w-full animate-in">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#1d2129]">Education ERP Login</h1>
                    ...
                    <div className="bg-blue-50/50 rounded-xl p-6 border border-blue-100 shadow-inner">
                        ...
                        <div className="grid grid-cols-2 gap-6 text-[11px]">
                            ...
                            <div className="col-span-2 pt-2 border-t border-blue-100">
                                ...
                                <p className="text-gray-500 italic">Use the credentials provided in the Super Admin panel</p>
                            </div>
                        </div>
                    </div>
                    <p className="text-[12px] text-gray-400 text-center">Education Hub Operations & HR Management System</p>
                </div>
            </div>
        </div>
    );
