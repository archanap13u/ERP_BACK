...
const PRESETS = [
    {
        name: 'Full HR Portal',
        features: ['HR Workspace', 'Employees', 'Attendance', 'Announcements', 'Holidays', 'Performance'],
        description: 'Complete suite for Human Resources management'
    },
    {
        name: 'Operations Portal',
        features: ['Operations', 'Student Management', 'Student', 'Application', 'Program'],
        description: 'Academic and operational management focus'
    },
    {
        name: 'Finance & ERP',
        features: ['Finance', 'Inventory', 'CRM', 'Sales Order', 'Sales Invoice'],
        description: 'Commercial and financial management tools'
    },
    {
        name: 'Basic Education',
        features: ['Student Management', 'Attendance', 'Announcements'],
        description: 'Essential tools for student interaction'
    }
];
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {PRESETS.map((preset) => (
                                    ...
                                    >
                                        <p className="font-bold text-[#1d2129] group-hover:text-blue-600 transition-colors">{preset.name}</p>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {ALL_FEATURES.map((feature) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className={`text-[13px] font-bold ${isActive ? 'text-white' : 'text-[#1d2129]'}`}>{feature}</span>
                                        {isActive && <Check size={16} className="text-blue-100" />}
                                    </button>
                                );
                            })}
                        </div>
